...
<html lang="en">
    ...
    <body>
        ...
        <div class="home-btn d-none d-sm-block">
                <a href="{{route('detection.admin')}}" class="text-white"><i class="fas fa-home h2"></i></a>
            </div>
                ...
                <div class="card card-pages shadow-none">
                    ...
                    <div class="card-body">
                        <div class="text-center m-t-0 m-b-15">
                                <a href="{{route('detection.admin')}}" class="logo logo-admin"><img src="assets/images/logo-dark.png" alt="" height="24"></a>
                        </div>
                        <h5 class="font-18 text-center">{{$register}}</h5>

                        <form class="form-horizontal m-t-30" action="{{route('detection.admin')}}">
                            ...
                            <div class="form-group mb-0 row">
                                    <div class="col-12 m-t-10 text-center">
                                        <a href="{{route('detection.login')}}" class="text-muted">Already have account?</a>
                                    </div>
                                </div>
                        </form>
                    </div>
